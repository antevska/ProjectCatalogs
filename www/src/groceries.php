<?php include_once "bk/groceries_bk.php"?>
...
<head>
    ...
    <link rel="stylesheet" href="style/groceries.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-family: 'IBM Plex Sans', sans-serif; font-size: 10pt;">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="groceries.php">Go shopping! <span class="sr-only">(current)</span></a></li>
